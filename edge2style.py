...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='pa_face', help='dataset_name')
...
def make_edge_smooth(dataset_name, img_size) :
    file_list = glob('datasets/{}/{}/*.*'.format(dataset_name, 'style'))
    save_dir = 'datasets/{}/smooth'.format(dataset_name)
